            ...
            <div class="flex h-16 items-center justify-between px-4 sm:px-0">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                  <img class="h-4" src="http://studentevents.nz/assets/StudentEvents.svg?color=indigo&shade=500" alt="Student Events" />
                </div>
...
const navigation = [
  ...
  { name: 'Registered Users', href: '/admin/dash_users', current: false },
  { name: 'Manage Events', href: '/admin/manage_events', current: false },
  { name: 'Manage Bookings', href: '/admin/manage_bookings', current: false },
]
