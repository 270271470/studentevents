    ...
    <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
      <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-600">Reach out to us if you have any questions or suggestions. Our friendly team will get back to you within 24 hours.</p>
          <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
            <div class="flex gap-x-4">
              ...
              <dd>23 Anzac Road<br />Takapuna, Auckland, 0622</dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
              ...
              <dd><a class="hover:text-gray-900" href="tel:+64 (021) 234-5678">+64 (021) 234-5678</a></dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
              ...
              <dd><a class="hover:text-gray-900" href="mailto:help@studentevents.nz">help@studentevents.nz</a></dd>
            </div>
          </dl>
        </div>
      </div>
