<template>
      ...
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <img class="h-9 ml-5" src="http://studentevents.nz/assets/logo.svg?color=indigo&shade=500" alt="" />
          </a>
        </div>
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end lg:space-x-8">
          ...
          <a href="/register" class="bg-indigo-600 hover:bg-indigo-800 text-white font-semibold py-2 px-4 rounded">
            Register
          </a>
          <a href="/login" class="bg-green-500 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded">
            Log in
          </a>
        </div>
      </nav>
        ...
        <DialogPanel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/25">
              ...
              <div class="py-6">
                <a href="/register" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-gray-800">Register</a>
              </div>
            </div>
          </div>
        </DialogPanel>
  ...
  <div class="relative isolate overflow-hidden pt-14">
    ...
    <div class="max-w-3xl py-32 sm:py-48 lg:py-44 pl-12">
      <div class="text-left">
    ...
    <div class="absolute right-48 top-48 z-10">
      <img src="https://www.studentevents.nz/assets/koru.png" alt="Koru" class="w-64 h-64 opacity-5" style="width: 375px; height: 375px;" />
    </div>
