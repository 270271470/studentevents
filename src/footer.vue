  ...
  <footer class="bg-gray-900" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <img class="h-2" src="http://studentevents.nz/assets/StudentEvents.svg?color=indigo&shade=500" alt="Student Events" />
...
const navigation = {
  events: [
    { name: 'Workshops', href: '#' },
    { name: 'Adventure', href: '#' },
    { name: 'Outdoor Seminars', href: '#' },
    { name: 'Clubs', href: '#' },
  ],
  quicklinks: [
    { name: 'Featured Events', href: '#' },
